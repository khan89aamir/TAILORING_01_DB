...
BEGIN
	...
	SET @PARAMERES=CONCAT(@EmployeeCode,',',@Name,',',@MobileNo,',',@Gender,',',@DOB,',',@Address,',',@Photo,',',@UpdatedBy)
	BEGIN TRANSACTION

	UPDATE EmployeeDetails SET
	EmployeeCode=@EmployeeCode,Name=@Name,MobileNo=@MobileNo,Gender=@Gender,DOB=IIF(@DOB='',null,@DOB),[Address]=@Address
