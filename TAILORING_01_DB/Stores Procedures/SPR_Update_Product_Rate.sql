...
BEGIN
	...
	SET @PARAMERES=CONCAT(@GarmentRateID,',',@GarmentID,',',@GarmentCode,',',@Rate,',',@OrderType,',',@UpdatedBy)
	BEGIN TRANSACTION

	UPDATE [dbo].[tblProductRateMaster] SET 
	GarmentID=@GarmentID,GarmentCode=@GarmentCode
